...
<head>
    ...
    <!-- BEGIN: Vendor CSS-->
    <?php foreach ($assets['cssesVendor'] as $cssVendor) {
        echo $cssVendor;
    }; ?>
    <!-- END: Vendor CSS-->
    ...
    <!-- BEGIN: Page CSS-->
    <?php foreach ($assets['csses'] as $css) {
        echo $css;
    }; ?>
    <!-- END: Page CSS-->
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand" href="<?= base_url('admin'); ?>"><span class="brand-logo">
                        ...
                        <h2 class="brand-text">MegaNet</h2>
                    </a></li>
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="<?= $page == 'dashboard' ? 'active' : ''; ?>"><a class="d-flex align-items-center" href="<?= base_url('admin/dashboard'); ?>"><i data-feather="home"></i><span class="menu-item text-truncate" data-i18n="Dashboard">Dashboard</span></a>
                </li>
                ...
                <li class="<?= $page == 'devices' ? 'active' : ''; ?> nav-item"><a class="d-flex align-items-center" href="devices"><i data-feather="key"></i><span class="menu-title text-truncate" data-i18n="SSH Config">Thiết Bị</span></a>
                </li>
